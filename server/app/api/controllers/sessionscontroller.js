...
(function() {
  var AppError, FaceBookClient, SessionsController, conf, controller, models, querystring, utils, _ref,
  ...
  SessionsController = (function(_super) {
    ...
    function SessionsController() {
      ...
      this.createSession = __bind(this.createSession, this);      _ref = SessionsController.__super__.constructor.apply(this, arguments);
      return _ref;
    }
    ...
    SessionsController.prototype.parseFBUserDetails = function(userDetails) {
      ...
      return {
        ...
        username: (_ref1 = userDetails.username) != null ? _ref1 : userDetails.id,
