...
(function() {
  var AppError, UsersController, conf, controller, fs, models, _ref,
  ...
  UsersController = (function(_super) {
    ...
    function UsersController() {
      ...
      this.getUsers = __bind(this.getUsers, this);      _ref = UsersController.__super__.constructor.apply(this, arguments);
      return _ref;
    }
        ...
        if (req.user.id === req.params.id) {
          return models.User.getById(req.user.id, {
            ...
            return models.UserInfo.get({
              ...
              var lastAccessMessageTime, _ref1;

              lastAccessMessageTime = (_ref1 = userinfo.lastAccessMessageTime) != null ? _ref1 : 0;
